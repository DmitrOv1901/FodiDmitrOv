...
struct LampTileInfo { int2 fieldOrigin,size,tileOffset; };
std::vector<LampTileInfo> _LampTileInfos;
Texture _LampTiles,_LampTilesInput;
int2 _LampTileOffset,_ComposeOrigin,_ComposeSize;
int _LampTileCount=0;
static const float LampNearCells = 6.0f;
static const int LampEmitterPointsPerAxis = 3;
int2 _LampPolarSize;
int _LampPolarPoint=0;
Texture _LampPolar,_LampPolarInput;
