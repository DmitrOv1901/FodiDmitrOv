...
- Фолбеки ЗАБОРОНЕНІ НІКОЛИ і ніде: жодних запасних значень, спрощених шляхів чи тихих підмін, коли основних даних нема. Нема текселя — чорний, нема даних — помилка або порожньо, а не правдоподібна підробка. Маскування відсутності даних фолбеком — це баг, а не стійкість.
