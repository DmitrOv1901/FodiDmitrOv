...
namespace Fodinae.Assets.Scripts.World
{
    ...
    public class TerrainRenderingDiagnostics : MonoBehaviour
    {
        ...
        private void Initialize()
        {
            ...
            Debug.Log("TerrainRenderingDiagnostics: Initialized");
        }
        ...
        public void RunDiagnosticCheck()
        {
            if (!_isInitialized)
            {
                Debug.LogError("TerrainRenderingDiagnostics: Not initialized");
                return;
            }
        ...
        {
            _errorHistory.Clear();
            Debug.Log("TerrainRenderingDiagnostics: Error history cleared");
        }
        ...
        {
            Debug.Log("TerrainRenderingDiagnostics: Destroyed");
        }
    }
}